#!/usr/bin/env python3
"""
Fetch coduri de reducere Notino de pe shopilo.ro
Sursa: https://shopilo.ro/magazin/notino.ro
"""
...
SHOPILO_URL = "https://shopilo.ro/magazin/notino.ro"
STORE_NAME = "Notino"


def fetch_coupons(url=SHOPILO_URL):
    """Returneaza lista de cupoane active pentru Notino de pe shopilo.ro"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-ro/cod-reducere-notino)"
    }
    try:
